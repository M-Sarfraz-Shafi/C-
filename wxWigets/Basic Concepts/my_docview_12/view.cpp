...
void ImageView::Draw_mini_rect(wxDC *dc)
{
    ...
    //  x_values[1] = x_values[0]+w/7;
    //  x_values[2] = x_values[1]+w/7;
    //  x_values[3] = x_values[2]+w/7;
    //  x_values[4] = x_values[3]+w/7;
    //  x_values[5] = x_values[4]+w/7;
    //  x_values[6] = x_values[5]+w/7;
    //  x_values[7] = x_values[6]+w/7;

    //cout<<"width :"<<w<< "x_values: "<<x_values[1]<<endl;
    // cout<<"Total hight is "<<h<<endl;
    y_values[0] = 0;
    int y_points = 9;
    ...
    // y_values[1] = y_values[0]+ h/5;
    // y_values[2] = y_values[1]+ h/5;
    // y_values[3] = y_values[2]+ h/5;
    // y_values[4] = y_values[3]+ h/5;
    // y_values[5] = y_values[4]+ h/5;
    //y_values[6] = y_values[5]+ h/6;

    //cout<<"Hight: "<<h<<"y value"<<y_values[1]<<endl;

    wxCoord w1 = x_values[1] - x_values[0], h1 = y_values[1] - y_values[0];
    //wxCoord w2 = x_values[2] - x_values[1], h2 = y_values[2] - y_values[1];

    //cout<<"w1: "<<w1<<"h1: "<<h1<<endl;
    //cout<<"Check XX! "<<X1<<" Y1: "<<Y1<<endl;
    //cout<<"Check: x1: "<<X1+x_values[1]<<" y1: "<<h-y_values[1]<<endl;
    for (int row = 0; row < 4; row++)
    {
       
        for (int col = 0; col < 6; col++)
        {
            dc->DrawRectangle(X1 + x_values[col*2+1], Y1 + y_values[row*2+1], w1, h1);
        }
    }

    // dc->DrawRectangle(X1 + x_values[1], Y1 + y_values[1], w1, h1);
    // dc->DrawRectangle(X1 + x_values[3], Y1 + y_values[1], w1, h1);
    // dc->DrawRectangle(X1 + x_values[5], Y1 + y_values[1], w1, h1);
    // dc->DrawRectangle(X1 + x_values[1], Y1 + y_values[3], w1, h1);
    // dc->DrawRectangle(X1 + x_values[3], Y1 + y_values[3], w1, h1);
    // dc->DrawRectangle(X1 + x_values[5], Y1 + y_values[3], w1, h1);
