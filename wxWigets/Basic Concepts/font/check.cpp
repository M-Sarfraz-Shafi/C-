...
MyCanvas::MyCanvas(wxFrame* parent, wxString file, wxBitmapType format,int startX, int startY) : wxPanel(parent)
{
...
bool MyApp:: OnInit()
{
  ...
  // drawButton = new MyCanvas( m_frame, filename, wxBITMAP_TYPE_ANY,300,300);
   ...
   wxPanel * newPanel;
   newPanel = new wxPanel(m_frame,wxID_ANY, wxPoint(00,00), wxSize(100,100));
